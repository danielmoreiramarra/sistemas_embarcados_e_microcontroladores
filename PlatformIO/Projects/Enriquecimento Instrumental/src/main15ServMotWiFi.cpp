// #include <Arduino.h>
// #include <WiFi.h>  // biblioteca para usar WiFi do ESP32

// const int servoPin = 18;  /* GPIO18 */

// const char* ssid = "iPhone de Daniel (2)"; /* colocar o SSID do roteador */
// const char* password = "12345678"; /*colocar a senha correspondente */

// int dutyCycle = 0;
// //int position1 = 0;

// /* inicializando sinal PWM para controle do servomotor */
// const int PWMFreq = 50;  // 50 Hz
// const int PWMChannel = 0;
// const int PWMResolution = 8; // 8 bits
// const int MAX_DUTY_CYCLE = (int)(pow(2, PWMResolution) - 1);

// WiFiServer espServer(80); // instanciando o WiFiServer 
// // 80 é o número da porta para o servido web HTTP
